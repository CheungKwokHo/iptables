...
# wget -qO natcfg.sh https://raw.githubusercontent.com/CheungKwokHo/iptables/master/nat.sh && bash nat.sh
...
echo
setupService(){
    wget -qO /usr/local/bin/dnat.sh https://raw.githubusercontent.com/CheungKwokHo/iptables/master/dnat.sh||{
